  ...
  return (
    <div className="p-6 space-y-6 min-h-screen text-white">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="stat shadow-lg p-4 bg-gradient-to-r from-yellow-500 to-yellow-700 rounded-lg border border-gray-300 flex items-center">
        ...
        <div className="stat shadow-lg p-4 bg-gradient-to-r from-green-500 to-green-700 rounded-lg border border-gray-300 flex items-center">
        ...
        <div className="stat shadow-lg p-4 bg-gradient-to-r from-blue-500 to-blue-700 rounded-lg border border-gray-300 flex items-center">
        ...
        <div className="stat shadow-lg p-4 bg-gradient-to-r from-red-500 to-red-700 rounded-lg border border-gray-300 flex items-center">
